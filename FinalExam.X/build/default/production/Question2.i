...
void __attribute__((picinterrupt(("high_priority")))) Hi_ISR(void)
{
    if(PIR1bits.ADIF == 1){
        ...
        if(result >= 896){
            temp_for_timer = 34285;
        }
        else if(result >= 768){
            temp_for_timer = 40000;
        }
        else if(result >= 640){
            temp_for_timer = 45000;
        }
        else if(result >= 512){
            temp_for_timer = 49910;
        }
        else if(result >= 384){
            temp_for_timer = 51600;
        }
        else if(result >= 256){
            temp_for_timer = 53300;
        }
        else if(result >= 128){
            temp_for_timer = 55200;
        }
        else{
            temp_for_timer = 57772;
        }
        _delay(10);
        ADCON0bits.GO_DONE = 1;
    }
